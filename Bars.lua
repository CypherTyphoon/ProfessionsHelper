...
-- Mapping: Kategorie → Hauptberuf
local professionMapping = {
    Leather              = "Skinning",       -- Drop, Skinning, Leatherworking, etc.
    Ores                 = "Mining",         -- Drop, Vendor, Mining, Blacksmithing, ...
    MetalAndStone        = "Mining",         -- Drop, Mining, Blacksmithing, Engineering, ...
    Herbs                = "Herbalism",      -- Drop, Vendor, Herbalism, Alchemy, ...
    Cloth                = "Tailoring",      -- Drop, Tailoring, Tailoring, ...
    Cooking              = "Cooking",        -- Crafted/Drop, Cooking
    Elemental            = "AllProf",        -- Drop, allProf
    Enchanting           = "Enchanting",     -- Drop, Enchanting, Enchanting, Tailoring
    FinishingReagents    = "AllProf",        -- Crafted, multiple professions
    FoodOrDrink          = "Cooking",        -- Crafted, Cooking, Cooking
    Inscription          = "Inscription",    -- Inks & Pigments: Crafted, Inscription, ...
    Jewelcrafting        = "Jewelcrafting",  -- Crafted, Jewelcrafting, Jewelcrafting
    Meat                 = "Cooking",        -- Drop/Crafted, Cooking, Cooking (Fishing/Skinning are source)
    OptionalReagents     = "AllProf",        -- Crafted, multiple professions
    Part                 = "Engineering",    -- Crafted, Engineering
    PermanentItemEnhancement = "AllProf",    -- Crafted, allProf
    TradeGood            = "AllProf",        -- Mixed professions, e.g., Blacksmithing, Leatherworking, Alchemy, etc.
    Dust                 = "Enchanting",     -- Enchanting reagents
    Pigments             = "Inscription",    -- Inscription pigments
    Gems                 = "Jewelcrafting",  -- Jewelcrafting gems
    Ingots               = "Blacksmithing",  -- Blacksmithing ingots
    Wires                = "Engineering",    -- Engineering wires/components
}
...
local function HasProfessionForCategory(category)
    ...
    for _, index in ipairs(professionIndexes) do
        if index then
            ...
            if name and skillLine and skillLineMapping[skillLine] == prof then
                return true
            end
        end
    end
